...
heroku config:set SPOTIFY_REDIRECT_URI=https://playlist-mgr-39a919ee8105-1641bf424db9.herokuapp.com/auth/callback
...
echo "https://playlist-mgr-39a919ee8105-1641bf424db9.herokuapp.com/auth/callback"
echo ""
